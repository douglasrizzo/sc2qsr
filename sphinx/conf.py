...
from sc2qsr import __version__
...
latex_documents = [
    (master_doc, 'sc2qsr.tex', 'sc2qsr Documentation', 'Douglas De Rizzo Meneghetti', 'manual'),
]
...
man_pages = [(master_doc, 'sc2qsr', 'sc2qsr Documentation', [author], 1)]
...
texinfo_documents = [
    (
        master_doc, 'sc2qsr', 'sc2qsr Documentation', author, 'sc2qsr',
